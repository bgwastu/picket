...
export function DockerIcon(props: SVGProps<SVGSVGElement>) {
	return (
		<svg aria-hidden="true" {...props} viewBox="0 0 512 512" fill="currentColor">
...
export function ChartAverage(props: SVGProps<SVGSVGElement>) {
	return (
		<svg aria-hidden="true" fill="none" viewBox="0 0 48 48" stroke="currentColor" {...props}>
...
export function EthernetIcon(props: SVGProps<SVGSVGElement>) {
	return (
		<svg aria-hidden="true" fill="none" stroke="currentColor" strokeLinecap="round" strokeWidth="2" viewBox="0 0 24 24" {...props}>
...
export function ThermometerIcon(props: SVGProps<SVGSVGElement>) {
	return (
		<svg aria-hidden="true" viewBox="0 0 256 256" {...props} fill="currentColor">
...
export function GpuIcon(props: SVGProps<SVGSVGElement>) {
	return (
		<svg aria-hidden="true" viewBox="0 0 24 24" {...props} stroke="currentColor" fill="none" strokeWidth="2">
